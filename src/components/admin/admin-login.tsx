...
export default function AdminLogin({ onLogin, onBack }: AdminLoginProps) {
  ...
  const handleGoogleLogin = () => {
    toast.info('تسجيل الدخول عبر جوجل متوقف حالياً للصيانة')
  }
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-[9px]">
                  <span className="px-4 bg-[#0c0c0c] text-muted-foreground font-black uppercase tracking-[0.2em]">أو الدخول عبر</span>
                </div>
              </div>
              ...
              <Button
                ...
                className="w-full bg-white/5 border-white/10 text-white hover:bg-white/10 h-11 rounded-xl font-black transition-all flex gap-3 text-[10px]"
              >
        ...
        >
          <p className="text-muted-foreground/40 text-[9px] font-black uppercase tracking-[0.4em]">
            © {new Date().getFullYear()} ELBA7RAWY Advertising • Admin Panel
          </p>
          <div className="flex gap-2 items-center text-[8px] font-black text-primary/40 uppercase tracking-widest">
